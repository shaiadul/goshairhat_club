...
const players = [
  {
    name: "মো সায়েম হোসেন",
    description: "গোলকিপার , উচ্চতা ৫.৭'",
    teams: [
  ...
  },
  {
    ...
    description: "সেন্টার ব্যাক,ডিফেন্সিভ মিডফিল্ড উচ্চতা ৫.৮'",
    teams: [
      "শরিয়তপুর জেলা দল",
      "শরিয়তপুর জেলা দল অ-১৭",
      "ধানমন্ডি -২৪ স্পোর্টস একাডেমি",
      "গোসাইরহাট স্পোর্টস একাডেমি",
    ],
    image: "https://i.ibb.co/P6CNTpf/ador.jpg",
    hireLink: "tel:01311456330",
    date: "2023-10-30",
  },
  {
    name: "মো সাজন মিয়া",
